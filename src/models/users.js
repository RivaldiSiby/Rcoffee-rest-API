...
const getUserById = async (id) => {
  try {
    const query =
      "SELECT u.id,u.status,u.name,u.email,u.phone,u.date_birth,u.gender,u.address,u.img,u.last_name,u.first_name,r.name as role  FROM users u INNER JOIN role r ON u.role = r.id WHERE u.id = $1 ";
